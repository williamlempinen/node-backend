...
const UserRepo = {
    ...
    findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!user)
                    return [null, { type: errors_1.ErrorType.NOT_FOUND, errorMessage: `No user found with id: ${id}` }];
    ...
    registerUser(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (exists)
                    return [null, { type: errors_1.ErrorType.NOT_FOUND, errorMessage: `User with email: ${data.email} already exists` }];
                const hashedPassword = (0, authUtils_1.hashPassword)(data.password);
                const user = yield __1.prismaClient.user.create({ data: Object.assign(Object.assign({}, data), { password: hashedPassword }) });
                if (!user)
                    return [null, { type: errors_1.ErrorType.INTERNAL, errorMessage: 'Could not create new user' }];
    ...
    findAllActiveUsers() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const activeUsers = yield __1.prismaClient.user.findMany({ where: { is_active: true }, include: { contacts: true } });
                if (!activeUsers)
                    return [null, { type: errors_1.ErrorType.INTERNAL, errorMessage: 'Internal server error' }];
    ...
    isUserActive(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!isUserActive)
                    return [null, { type: errors_1.ErrorType.NOT_FOUND, errorMessage: 'User not found ' }];
