            ...
            try {
                ...
                if (!data.isGroup) {
                    ...
                    if (data.participants.length > 2) {
                        ...
                        return [
                            null,
                            { type: errors_1.ErrorType.BAD_REQUEST, errorMessage: 'Private conversations can only have two participants' }
                        ];
                    }
                    ...
                    if (e1 || e2 || !p1 || !p2)
                        return [null, { type: errors_1.ErrorType.BAD_REQUEST, errorMessage: 'Cannot find users to create conversation' }];
                    const [privateConversationExists, notExists] = yield ConversationRepo.getPrivateConversationIdFromParticipantIds(p1.id, p2.id);
                    ...
                    groupName = (p1 === null || p1 === void 0 ? void 0 : p1.username) + ' <> ' + (p2 === null || p2 === void 0 ? void 0 : p2.username);
                }
    ...
    getConversation(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!conversation)
                    return [null, { type: errors_1.ErrorType.NOT_FOUND, errorMessage: 'No conversations found' }];
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!groupConversations)
                    return [null, { type: errors_1.ErrorType.BAD_REQUEST, errorMessage: 'Bad request for getting group conversations' }];
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!isUserAdded)
                    return [
                        null,
                        { type: errors_1.ErrorType.BAD_REQUEST, errorMessage: 'Bad request for adding user to a group conversation' }
                    ];
                return [true, null];
            }
            catch (error) {
