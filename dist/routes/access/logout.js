...
router.post('/logout', (0, validator_1.validator)(schema_1.Access.logout), (0, asyncHandler_1.asyncHandler)((request, response, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { sessionId } = request.body;
    if (!sessionId)
        return next({ type: errors_1.ErrorType.BAD_REQUEST, message: 'Session id is required' });
    ...
    if (!setStatus)
        return next({ type: errors_1.ErrorType.INTERNAL, message: 'Error deleting refresh token' });
