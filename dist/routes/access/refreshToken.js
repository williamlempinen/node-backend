...
router.post('/refreshtoken', (0, validator_1.validator)(schema_1.Access.refreshToken), (0, asyncHandler_1.asyncHandler)((request, response, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    Logger_1.default.info(`Found token in DB: ${storedToken === null || storedToken === void 0 ? void 0 : storedToken.token_hash}`);
    Logger_1.default.info(`Token from client: ${request.body.refreshToken}`);
    if ((storedToken === null || storedToken === void 0 ? void 0 : storedToken.token_hash) !== request.body.refreshToken)
        return next({ type: errors_1.ErrorType.BAD_REQUEST, message: 'Invalid refresh token' });
    if (storedToken && (storedToken === null || storedToken === void 0 ? void 0 : storedToken.expires_at) < new Date()) {
    ...
    Logger_1.default.info(`Found token: ${storedToken}, for user id: ${storedToken === null || storedToken === void 0 ? void 0 : storedToken.user_id}`);
    const [user, errorInUserRepo] = yield UserRepo_1.default.findById(storedToken === null || storedToken === void 0 ? void 0 : storedToken.user_id);
    if (errorInUserRepo)
        return next({ type: errorInUserRepo.type, message: errorInUserRepo.errorMessage });
    Logger_1.default.info(`Found user: ${user === null || user === void 0 ? void 0 : user.email}, with id: ${user === null || user === void 0 ? void 0 : user.id}`);
    if (!user)
        return next({ type: errors_1.ErrorType.NOT_FOUND, message: 'User not found' });
