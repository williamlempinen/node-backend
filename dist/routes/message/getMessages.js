...
router.get('/get-messages/:conversationId/:pageNumber', (0, validator_1.validator)(schema_1.default.getMessage, validator_1.ValidationSource.PARAMS), (0, asyncHandler_1.asyncHandler)((request, response, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [getMessagesPage, error] = yield MessageRepo_1.default.getMessages(_conversationId, { page: _pageNumber, limit: 30 });
    if (error)
