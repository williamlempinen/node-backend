...
router.get(
  ...
  (0, validator_1.validator)(schema_1.default.getConversationId, validator_1.ValidationSource.PARAMS),
  (0, asyncHandler_1.asyncHandler)((request, response, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      const [conversationId, noConversation] =
        yield ConversationRepo_1.default.getPrivateConversationIdFromParticipantIds(parseInt(oneId), parseInt(secId))
      if (noConversation) return (0, responses_1.SuccessResponse)('No conversation', response)
