...
exports.getAccessToken =
  ...
  exports.deleteExpiredRefreshTokens =
  exports.createTokens =
  exports.checkPasswordHash =
    ...
    try {
      ...
      if (deleteResult.count > 0) {
        Logger_1.default.info(
          `Updated ${userIds.length} users' and deleted ${deleteResult.count} expired refresh tokens.`
        )
      }
    } catch (error) {
