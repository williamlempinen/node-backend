...
const redisSet = (id, data, expires) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const redisGet = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const redisDelete = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
