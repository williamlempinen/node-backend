...
router.get('/search-users', (0, asyncHandler_1.asyncHandler)((request, response, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { query } = request.query;
    if (!query || query.toString().length < 2)
        return;
    const [searchResults, error] = yield UserRepo_1.default.searchUsers({ searchQuery: query === null || query === void 0 ? void 0 : query.toString() });
    if (error) {
