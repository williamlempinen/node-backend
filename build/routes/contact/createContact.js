...
router.post('/create-contact', (0, validator_1.validator)(schema_1.default.pairContact), (0, asyncHandler_1.asyncHandler)((request, response, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (errorAdding)
        return next({ type: errorAdding.type, message: errorAdding.errorMessage });
