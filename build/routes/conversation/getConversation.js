...
router.get(`/get-conversation/:id`, (0, validator_1.validator)(schema_1.default.getConversation, validator_1.ValidationSource.PARAMS), (0, asyncHandler_1.asyncHandler)((request, response, next) => __awaiter(void 0, void 0, void 0, function* () {
