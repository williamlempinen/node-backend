    ...
    createMessage(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!isParticipant)
                    return [null, { type: errors_1.ErrorType.FORBIDDEN, errorMessage: 'User is not a participant in this conversation' }];
                ...
                if (!message)
                    return [null, { type: errors_1.ErrorType.BAD_REQUEST, errorMessage: 'Could not create message' }];
                const [isConversationUpdated, error] = yield ConversationRepo_1.default.updateConversationOnNewMessages(data.conversationId);
                if (error)
                    return [null, { type: error.type, errorMessage: error.errorMessage }];
                return [message, null];
            }
            catch (error) {
